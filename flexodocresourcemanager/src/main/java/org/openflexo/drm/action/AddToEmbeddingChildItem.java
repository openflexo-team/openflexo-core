...
public class AddToEmbeddingChildItem extends FlexoAction<AddToEmbeddingChildItem, FlexoObject, FlexoObject> {

	public static FlexoActionFactory<AddToEmbeddingChildItem, FlexoObject, FlexoObject> actionType = new FlexoActionFactory<AddToEmbeddingChildItem, FlexoObject, FlexoObject>(
			"add_embedding_child", FlexoActionFactory.newMenu, FlexoActionFactory.defaultGroup, FlexoActionFactory.ADD_ACTION_TYPE) {

		/**
		 * Factory method
		 */
		@Override
		public AddToEmbeddingChildItem makeNewAction(FlexoObject focusedObject, Vector<FlexoObject> globalSelection, FlexoEditor editor) {
	...
	private AddToEmbeddingChildItem(FlexoObject focusedObject, Vector<FlexoObject> globalSelection, FlexoEditor editor) {
