...
public class TestFMLParser extends OpenflexoTestCase {
	...
	@Test
	public void testMinimalDeclaration() {
		testFMLCompilationUnit(ResourceLocator.locateResource("FMLExamples/MinimalDeclaration.fml"));
	}

	@Test
	public void testAnnotations() {
		testFMLCompilationUnit(ResourceLocator.locateResource("FMLExamples/TestAnnotations.fml"));
	}
	...
	@Test
	public void testURI() {
		testFMLCompilationUnit(ResourceLocator.locateResource("FMLExamples/TestURI.fml"));
	}

	@Test
	public void testTestExpressionsAndEditionActions() {
		testFMLCompilationUnit(ResourceLocator.locateResource("FMLExamples/TestExpressionsAndEditionActions.fml"));
	}
	...
	@Test
	public void test4() {
		testFMLCompilationUnit(ResourceLocator.locateResource("FMLExamples/Test4.fml"));
	}
