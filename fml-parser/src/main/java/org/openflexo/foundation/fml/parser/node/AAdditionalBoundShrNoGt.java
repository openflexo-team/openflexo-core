...
public final class AAdditionalBoundShrNoGt extends PAdditionalBoundShrNoGt
{
    private TAmp _amp_;
    ...
    public AAdditionalBoundShrNoGt()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAdditionalBoundShrNoGt(
    ...
    {
        ((Analysis) sw).caseAAdditionalBoundShrNoGt(this);
    }
