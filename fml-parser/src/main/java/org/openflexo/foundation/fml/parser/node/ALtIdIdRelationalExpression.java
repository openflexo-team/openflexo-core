...
public final class ALtIdIdRelationalExpression extends PRelationalExpression
{
    ...
    public ALtIdIdRelationalExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALtIdIdRelationalExpression(
    ...
    {
        ((Analysis) sw).caseALtIdIdRelationalExpression(this);
    }
