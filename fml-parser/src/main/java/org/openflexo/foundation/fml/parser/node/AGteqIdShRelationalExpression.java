...
public final class AGteqIdShRelationalExpression extends PRelationalExpression
{
    ...
    public AGteqIdShRelationalExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGteqIdShRelationalExpression(
    ...
    {
        ((Analysis) sw).caseAGteqIdShRelationalExpression(this);
    }
