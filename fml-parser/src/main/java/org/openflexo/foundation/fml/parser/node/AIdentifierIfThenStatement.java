...
public final class AIdentifierIfThenStatement extends PIfThenStatement
{
    private TIf _if_;
    ...
    public AIdentifierIfThenStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIdentifierIfThenStatement(
            cloneNode(this._if_),
    ...
    {
        ((Analysis) sw).caseAIdentifierIfThenStatement(this);
    }
