...
public final class AUshrIdIdShiftExpression extends PShiftExpression
{
    ...
    public AUshrIdIdShiftExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUshrIdIdShiftExpression(
    ...
    {
        ((Analysis) sw).caseAUshrIdIdShiftExpression(this);
    }
