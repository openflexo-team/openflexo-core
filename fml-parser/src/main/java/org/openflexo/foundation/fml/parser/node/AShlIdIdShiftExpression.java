...
public final class AShlIdIdShiftExpression extends PShiftExpression
{
    ...
    public AShlIdIdShiftExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AShlIdIdShiftExpression(
    ...
    {
        ((Analysis) sw).caseAShlIdIdShiftExpression(this);
    }
