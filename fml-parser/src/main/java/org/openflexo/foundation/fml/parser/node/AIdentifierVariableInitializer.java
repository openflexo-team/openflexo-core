...
public final class AIdentifierVariableInitializer extends PVariableInitializer
{
    private TIdentifier _identifier_;
    private final LinkedList<PAdditionalIdentifier> _additionalIdentifiers_ = new LinkedList<PAdditionalIdentifier>();

    public AIdentifierVariableInitializer()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIdentifierVariableInitializer(
    ...
    {
        ((Analysis) sw).caseAIdentifierVariableInitializer(this);
    }
