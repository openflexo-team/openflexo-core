...
public final class AIdentifierIfThenElseStatement extends PIfThenElseStatement
{
    private TIf _if_;
    ...
    public AIdentifierIfThenElseStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIdentifierIfThenElseStatement(
            cloneNode(this._if_),
    ...
    {
        ((Analysis) sw).caseAIdentifierIfThenElseStatement(this);
    }
