...
public final class ATypeArgumentsUshrNoGt extends PTypeArgumentsUshrNoGt
{
    private TLt _lt_;
    private PActualTypeArgumentList _actualTypeArgumentList_;

    public ATypeArgumentsUshrNoGt()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATypeArgumentsUshrNoGt(
            cloneNode(this._lt_),
    ...
    {
        ((Analysis) sw).caseATypeArgumentsUshrNoGt(this);
    }
