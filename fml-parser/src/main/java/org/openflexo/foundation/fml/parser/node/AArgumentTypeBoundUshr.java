...
public final class AArgumentTypeBoundUshr extends PTypeBoundUshr
{
    ...
    public Object clone()
    {
        return new AArgumentTypeBoundUshr(
    ...
    {
        ((Analysis) sw).caseAArgumentTypeBoundUshr(this);
    }
