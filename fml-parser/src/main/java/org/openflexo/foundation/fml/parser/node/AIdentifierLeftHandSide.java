...
public final class AIdentifierLeftHandSide extends PLeftHandSide
{
    ...
    public Object clone()
    {
        return new AIdentifierLeftHandSide(
    ...
    {
        ((Analysis) sw).caseAIdentifierLeftHandSide(this);
    }
