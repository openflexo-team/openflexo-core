...
public final class AIdentifierPrimaryNoNewArray extends PPrimaryNoNewArray
{
    ...
    public AIdentifierPrimaryNoNewArray()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIdentifierPrimaryNoNewArray(
    ...
    {
        ((Analysis) sw).caseAIdentifierPrimaryNoNewArray(this);
    }
