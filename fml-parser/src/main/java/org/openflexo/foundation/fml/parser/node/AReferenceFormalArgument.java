...
public final class AReferenceFormalArgument extends PFormalArgument
{
    ...
    public AReferenceFormalArgument()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AReferenceFormalArgument(
    ...
    {
        ((Analysis) sw).caseAReferenceFormalArgument(this);
    }
