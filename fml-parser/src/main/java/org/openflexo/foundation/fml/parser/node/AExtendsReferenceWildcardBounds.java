...
public final class AExtendsReferenceWildcardBounds extends PWildcardBounds
{
    ...
    public AExtendsReferenceWildcardBounds()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExtendsReferenceWildcardBounds(
    ...
    {
        ((Analysis) sw).caseAExtendsReferenceWildcardBounds(this);
    }
