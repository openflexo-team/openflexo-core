...
public final class AQmakrIdIdOrConditionalExpression extends PConditionalExpression
{
    ...
    public AQmakrIdIdOrConditionalExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AQmakrIdIdOrConditionalExpression(
    ...
    {
        ((Analysis) sw).caseAQmakrIdIdOrConditionalExpression(this);
    }
