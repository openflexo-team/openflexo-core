...
public final class ABarIdIdInclusiveOrExpression extends PInclusiveOrExpression
{
    ...
    public ABarIdIdInclusiveOrExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABarIdIdInclusiveOrExpression(
    ...
    {
        ((Analysis) sw).caseABarIdIdInclusiveOrExpression(this);
    }
