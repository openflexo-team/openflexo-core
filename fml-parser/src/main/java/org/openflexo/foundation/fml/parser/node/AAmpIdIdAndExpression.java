...
public final class AAmpIdIdAndExpression extends PAndExpression
{
    ...
    public Object clone()
    {
        return new AAmpIdIdAndExpression(
    ...
    {
        ((Analysis) sw).caseAAmpIdIdAndExpression(this);
    }
