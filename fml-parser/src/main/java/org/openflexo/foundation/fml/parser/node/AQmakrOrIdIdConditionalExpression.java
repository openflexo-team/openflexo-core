...
public final class AQmakrOrIdIdConditionalExpression extends PConditionalExpression
{
    ...
    public AQmakrOrIdIdConditionalExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AQmakrOrIdIdConditionalExpression(
    ...
    {
        ((Analysis) sw).caseAQmakrOrIdIdConditionalExpression(this);
    }
