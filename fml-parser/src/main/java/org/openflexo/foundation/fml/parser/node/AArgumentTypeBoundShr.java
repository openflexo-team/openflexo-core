...
public final class AArgumentTypeBoundShr extends PTypeBoundShr
{
    ...
    public Object clone()
    {
        return new AArgumentTypeBoundShr(
    ...
    {
        ((Analysis) sw).caseAArgumentTypeBoundShr(this);
    }
