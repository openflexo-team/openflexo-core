...
public final class AOneFormalParameters extends PFormalParameters
{
    private PFormalParameter _formalParameter_;

    public AOneFormalParameters()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOneFormalParameters(
            cloneNode(this._formalParameter_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAOneFormalParameters(this);
    }
