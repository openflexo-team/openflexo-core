...
public final class AShrIdIdShiftExpression extends PShiftExpression
{
    ...
    public AShrIdIdShiftExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AShrIdIdShiftExpression(
    ...
    {
        ((Analysis) sw).caseAShrIdIdShiftExpression(this);
    }
