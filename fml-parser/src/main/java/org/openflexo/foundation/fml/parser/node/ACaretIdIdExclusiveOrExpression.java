...
public final class ACaretIdIdExclusiveOrExpression extends PExclusiveOrExpression
{
    ...
    public ACaretIdIdExclusiveOrExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACaretIdIdExclusiveOrExpression(
    ...
    {
        ((Analysis) sw).caseACaretIdIdExclusiveOrExpression(this);
    }
