...
public final class AReferenceActualTypeArgument extends PActualTypeArgument
{
    ...
    public AReferenceActualTypeArgument()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AReferenceActualTypeArgument(
    ...
    {
        ((Analysis) sw).caseAReferenceActualTypeArgument(this);
    }
