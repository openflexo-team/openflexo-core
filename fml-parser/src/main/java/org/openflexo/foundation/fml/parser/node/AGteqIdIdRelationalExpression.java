...
public final class AGteqIdIdRelationalExpression extends PRelationalExpression
{
    ...
    public AGteqIdIdRelationalExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGteqIdIdRelationalExpression(
    ...
    {
        ((Analysis) sw).caseAGteqIdIdRelationalExpression(this);
    }
