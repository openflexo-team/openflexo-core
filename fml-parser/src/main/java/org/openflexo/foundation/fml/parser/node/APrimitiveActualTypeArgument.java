...
public final class APrimitiveActualTypeArgument extends PActualTypeArgument
{
    private PPrimitiveType _primitiveType_;
    private final LinkedList<PDim> _dims_ = new LinkedList<PDim>();

    public APrimitiveActualTypeArgument()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrimitiveActualTypeArgument(
    ...
    {
        ((Analysis) sw).caseAPrimitiveActualTypeArgument(this);
    }
