...
public final class AReferenceArrayCreationExpression extends PArrayCreationExpression
{
    private TNew _new_;
    ...
    public AReferenceArrayCreationExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AReferenceArrayCreationExpression(
    ...
    {
        ((Analysis) sw).caseAReferenceArrayCreationExpression(this);
    }
