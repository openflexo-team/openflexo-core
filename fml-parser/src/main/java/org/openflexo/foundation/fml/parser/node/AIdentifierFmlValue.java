...
public final class AIdentifierFmlValue extends PFmlValue
{
    ...
    public Object clone()
    {
        return new AIdentifierFmlValue(
    ...
    {
        ((Analysis) sw).caseAIdentifierFmlValue(this);
    }
