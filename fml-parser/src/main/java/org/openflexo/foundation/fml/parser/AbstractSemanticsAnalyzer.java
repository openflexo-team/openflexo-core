 ...
 * 
 */
public abstract class AbstractSemanticsAnalyzer extends DepthFirstAdapter {
	...
	public AbstractSemanticsAnalyzer(FMLModelFactory factory, Node rootNode) {
	...
	public abstract FMLSemanticsAnalyzer getAnalyzer();
