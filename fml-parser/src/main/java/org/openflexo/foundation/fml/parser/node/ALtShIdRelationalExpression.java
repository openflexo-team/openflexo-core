...
public final class ALtShIdRelationalExpression extends PRelationalExpression
{
    ...
    public ALtShIdRelationalExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALtShIdRelationalExpression(
    ...
    {
        ((Analysis) sw).caseALtShIdRelationalExpression(this);
    }
