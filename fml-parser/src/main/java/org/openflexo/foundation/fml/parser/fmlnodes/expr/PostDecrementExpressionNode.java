...
public class PostDecrementExpressionNode extends FMLUnaryOperatorExpressionNode<APostDecrExp> {
	...
	public PostDecrementExpressionNode(APostDecrExp astNode, AbstractExpressionFactory expressionFactory) {
		super(astNode, expressionFactory);
	}

	public PostDecrementExpressionNode(FMLUnaryOperatorExpression expression, AbstractExpressionFactory expressionFactory) {
