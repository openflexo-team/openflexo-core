...
public final class ASuperReferenceWildcardBounds extends PWildcardBounds
{
    ...
    public ASuperReferenceWildcardBounds()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASuperReferenceWildcardBounds(
    ...
    {
        ((Analysis) sw).caseASuperReferenceWildcardBounds(this);
    }
