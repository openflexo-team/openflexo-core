...
public final class APlusIdentifierUnaryExpression extends PUnaryExpression
{
    ...
    public Object clone()
    {
        return new APlusIdentifierUnaryExpression(
    ...
    {
        ((Analysis) sw).caseAPlusIdentifierUnaryExpression(this);
    }
