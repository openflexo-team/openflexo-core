...
public final class ALteqIdIdRelationalExpression extends PRelationalExpression
{
    ...
    public ALteqIdIdRelationalExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALteqIdIdRelationalExpression(
    ...
    {
        ((Analysis) sw).caseALteqIdIdRelationalExpression(this);
    }
