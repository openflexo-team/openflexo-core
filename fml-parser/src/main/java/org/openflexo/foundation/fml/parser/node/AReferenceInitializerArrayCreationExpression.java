...
public final class AReferenceInitializerArrayCreationExpression extends PArrayCreationExpression
{
    private TNew _new_;
    ...
    public AReferenceInitializerArrayCreationExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AReferenceInitializerArrayCreationExpression(
    ...
    {
        ((Analysis) sw).caseAReferenceInitializerArrayCreationExpression(this);
    }
