...
public final class AMinusIdentifierUnaryExpression extends PUnaryExpression
{
    ...
    public Object clone()
    {
        return new AMinusIdentifierUnaryExpression(
    ...
    {
        ((Analysis) sw).caseAMinusIdentifierUnaryExpression(this);
    }
