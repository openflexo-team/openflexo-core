...
public final class AAmpAmpIdIdConditionalAndExpression extends PConditionalAndExpression
{
    ...
    public AAmpAmpIdIdConditionalAndExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAmpAmpIdIdConditionalAndExpression(
    ...
    {
        ((Analysis) sw).caseAAmpAmpIdIdConditionalAndExpression(this);
    }
