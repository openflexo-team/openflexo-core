...
public final class AIdentifierElementValue extends PElementValue
{
    ...
    public Object clone()
    {
        return new AIdentifierElementValue(
    ...
    {
        ((Analysis) sw).caseAIdentifierElementValue(this);
    }
