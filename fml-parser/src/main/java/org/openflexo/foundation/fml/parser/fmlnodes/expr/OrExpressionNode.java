...
public class OrExpressionNode extends FMLBinaryOperatorExpressionNode<ABarBarConditionalOrExp> {
	...
	public BinaryOperator getOperator() {
		return FMLBooleanBinaryOperator.OR;
	}

	@Override
	public OrExpressionNode deserialize() {
		getModelObject().setLeftArgument(getExpressionFactory().getExpression(getASTNode().getConditionalOrExp()));
		getModelObject().setRightArgument(getExpressionFactory().getExpression(getASTNode().getConditionalAndExp()));
		super.deserialize();
		return this;
	}
