...
public class CellView extends BoxView {
    ...
    public CellView(Element elem) {
        ...
        FlexoStyledDocument.CellElement cell = (FlexoStyledDocument.CellElement)this.getElement();
    ...
    public float getPreferredSpan(int axis) {
        float span=0;
        if (axis==View.X_AXIS) {
            FlexoStyledDocument.CellElement cell=(FlexoStyledDocument.CellElement)getElement();
            span=cell.getWidth();
        }
        else {
            FlexoStyledDocument.CellElement cell=(FlexoStyledDocument.CellElement)getElement();
