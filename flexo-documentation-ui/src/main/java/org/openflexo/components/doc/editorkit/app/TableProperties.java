...
public class TableProperties extends JDialog {
    ...
    FlexoStyledDocument.TableElement table=null;
    FlexoStyledDocument.RowElement row=null;
    FlexoStyledDocument.CellElement cell=null;
    ...
    public void setTable(Element el) {
        ...
        table=(FlexoStyledDocument.TableElement)el;
    ...
    public void setRow(Element el) {
        ...
        row=(FlexoStyledDocument.RowElement)el;
    ...
    public void setCell(Element el) {
        ...
        cell=(FlexoStyledDocument.CellElement)el;
