 ...
 * attributes. Cell to reflect cell attributes.
 *
...
public class TableProperties extends JDialog {
	...
	protected void init() {
		...
		getContentPane().add(pAlign, new GridBagConstraints(0, 0, 3, 1, 1, 0, GridBagConstraints.NORTHEAST, GridBagConstraints.BOTH,
				new Insets(0, 0, 0, 0), 0, 0));

		getContentPane().add(bc, new GridBagConstraints(0, 1, 1, 3, 1, 0, GridBagConstraints.NORTHEAST, GridBagConstraints.BOTH,
				new Insets(0, 0, 0, 0), 0, 0));

		getContentPane().add(new JLabel("Width:"), new GridBagConstraints(1, 1, 1, 1, 0, 0, GridBagConstraints.NORTHEAST,
				GridBagConstraints.NONE, new Insets(10, 0, 0, 0), 0, 0));
		getContentPane().add(widthSpin, new GridBagConstraints(2, 1, 1, 1, 1, 0, GridBagConstraints.NORTHEAST, GridBagConstraints.BOTH,
				new Insets(10, 0, 0, 0), 0, 0));
		getContentPane().add(new JLabel("Height:"), new GridBagConstraints(1, 2, 1, 1, 0, 0, GridBagConstraints.NORTHEAST,
				GridBagConstraints.NONE, new Insets(0, 0, 10, 0), 0, 0));
		getContentPane().add(heightSpin, new GridBagConstraints(2, 2, 1, 1, 1, 0, GridBagConstraints.NORTHEAST, GridBagConstraints.BOTH,
				new Insets(0, 0, 10, 0), 0, 0));
		getContentPane().add(mc, new GridBagConstraints(1, 3, 2, 1, 1, 0, GridBagConstraints.NORTHEAST, GridBagConstraints.BOTH,
				new Insets(0, 0, 0, 0), 0, 0));
		...
		getContentPane().add(p, new GridBagConstraints(2, 4, 1, 1, 0, 0, GridBagConstraints.NORTHEAST, GridBagConstraints.NONE,
				new Insets(0, 0, 0, 0), 0, 0));

		getContentPane().add(new JLabel(""), new GridBagConstraints(2, 5, 1, 1, 0, 1, GridBagConstraints.NORTHEAST, GridBagConstraints.BOTH,
				new Insets(0, 0, 0, 0), 0, 0));
		pack();
	}

	/**
	 * Sets table element. Dialog setVisible(true)s table's borders. Dialog setVisible(true)s table width and height but user can't edit
	 * these values (we don't know how to distribute changed space between existing rows and columns). Also we always setVisible(true)s
	 * margins equal to 2 because different cell can contain different margins values.
	 *
	 * @param el
	 *            table element
	 */
	...
	/**
	 * Sets row element. Dialog setVisible(true)s row's borders (Row doesn't process horizontal (inner) border so this check box can
	 * contains any value). Dialog setVisible(true)s row width and height but user can't edit only height (we set this height to each of
	 * cell). Also we always setVisible(true)s margins equal to 2 because different cell can contain different margins values.
	 *
	 * @param el
	 *            row element
	 */
	...
	/**
	 * Sets cell element. Dialog setVisible(true)s cell's borders (cell doesn't process horizontal and vertical (inner) border so thess
	 * check boxes can contains any values). Dialog setVisible(true)s cell width and height.
	 *
	 * @param el
	 *            cell element
	 */
