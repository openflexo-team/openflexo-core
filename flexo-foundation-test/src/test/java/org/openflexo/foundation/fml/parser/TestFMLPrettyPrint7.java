...
public class TestFMLPrettyPrint7 extends FMLParserTestCase {

	private static FMLCompilationUnit compilationUnit;
	private static VirtualModel virtualModel;
	private static GetSetProperty<?> getSetProperty;
	...
	private static GetSetPropertyNode getSetNode;
	...
	public void loadInitialVersion() throws ParseException, ModelDefinitionException, IOException {
		...
		final Resource fmlFile = ResourceLocator.locateResource("TestFMLPrettyPrint7/InitialModel.fml");
		...
		testNormalizedFMLRepresentationEquals(compilationUnit, "TestFMLPrettyPrint7/Step1Normalized.fml");

		System.out.println("FML=\n" + compilationUnit.getFMLPrettyPrint());
		testFMLPrettyPrintEquals(compilationUnit, "TestFMLPrettyPrint7/Step1PrettyPrint.fml");
