...
/**
 * Test Sequence in Iteration
 * 
 * @author sylvain
 * 
 */
@RunWith(OrderedRunner.class)
public class TestSequenceInIteration extends OpenflexoProjectAtRunTimeTestCase {
	...
	public void testLoadViewPoint() throws FileNotFoundException, ResourceLoadingCancelledException, FlexoException {
		...
		assertNotNull(vpLib);
		vm = vpLib.getVirtualModel("http://openflexo.org/test/TestResourceCenter/TestSequenceInIteration.fml");
		assertNotNull(vm);
