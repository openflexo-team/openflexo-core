...
public class TestEvent extends OpenflexoTestCase {
	...
	public void testLoadViewPoint() throws FileNotFoundException, ResourceLoadingCancelledException, FlexoException {
		...
		vm = vpLib.getVirtualModel("http://openflexo.org/test/TestResourceCenter/TestEvent.fml");
		assertNotNull(vm);

		System.out.println("Normalized: " + vm.getNormalizedFML());
