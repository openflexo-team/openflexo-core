...
public class TestFMLPrettyPrint9 extends FMLParserTestCase {
	...
	public void loadInitialVersion() throws ParseException, ModelDefinitionException, IOException {
		...
		final Resource fmlFile = ResourceLocator.locateResource("TestFMLPrettyPrint9/InitialModel.fml");
		compilationUnit = parseFile(fmlFile);
		assertNotNull(virtualModel = compilationUnit.getVirtualModel());
		assertEquals("TestConceptualModel", virtualModel.getName());
		...
		testNormalizedFMLRepresentationEquals(compilationUnit, "TestFMLPrettyPrint9/Step1Normalized.fml");

		System.out.println("FML=\n" + compilationUnit.getFMLPrettyPrint());
		testFMLPrettyPrintEquals(compilationUnit, "TestFMLPrettyPrint9/Step1PrettyPrint.fml");
