 ...
 * 
 * This abstract class represents an object. (a "model" in the model-view
 * paradigm)<br>
 * 
 * This class provides default implementation for validation (see
 * {@link Validable} interface). When relevant, just extends interface
 * {@link Validable} and implements both methods
 * {@link Validable#getDefaultValidationModel()} and
...
public abstract interface FlexoObject extends AccessibleProxyObject, DeletableProxyObject, CloneableProxyObject, KeyValueCoding, Validable {
    ...
    /**
     * Return the list of all references to FlexoConceptInstance where this
     * FlexoObject is involved in a FlexoRole
     * 
     * @return
     */
    ...
    */
    ...
    /**
     * Return FlexoConceptInstance matching supplied id represented as a string,
     * which could be either the name of FlexoConcept, or its URI<br>
     * If many FlexoConceptInstance are declared in this FlexoProjectObject,
     * return first one
     * 
     * @param flexoConceptId
     * @return
    ...
    public static abstract class FlexoObjectImpl extends FlexoObservable implements FlexoObject {
        ...
        private static final Logger                                                      logger                   = Logger.getLogger(FlexoObject.class
                                                                                                                          .getPackage()
                                                                                                                          .getName());
        ...
        /**
         * A map that stores all the actions for each class (computed with the
        ...
        /**
         * Returns fully qualified name for this object NOTE: not used anymore,
         * should disappear
         * 
         * @return
         */
        ...
        /**
         * Return FlexoConceptInstance matching supplied id represented as a
         * string, which could be either the name of FlexoConcept, or its URI<br>
         * If many FlexoConceptInstance are declared in this FlexoProjectObject,
         * return first one
         * 
         * @param flexoConceptId
        ...
        /**
         * Temporary method to prevent notifications. This should never be used
         * by anyone except the screenshot generator
         */
        ...
        /**
         * Temporary method to reactivate notifications. This should never be
         * used by anyone except the screenshot generator
         */
        ...
        /**
         * Overrides default {@link #setModified(boolean)} method by providing
         * extended support for modification propagation for resource embedding
         */
        @Override
         ...
         * If object is part of a {@link ResourceData}, mark the
         * {@link ResourceData} to be modified, and thus, related resource to be
         ...
         * decoration meaning that the description is missing will only appears
         * on object for wich this method return true. So this method has to be
        ...
        /**
         * Returns a flag indicating if this object is valid according to
         * default validation model<br>
         * This method only works if this is an instance of {@link Validable}
         * interface, otherwise return true
         * 
         * @return boolean
         */
        @Override
         ...
         * validation model is used to perform this validation.<br>
         * This method only works if this is an instance of {@link Validable}
         * interface, otherwise return null
         */
        @Override
        ...
        /**
         * Validates this object by building new ValidationReport object
         * Supplied validation model is used to perform this validation.<br>
         * This method only works if this is an instance of {@link Validable}
         * interface, otherwise return null
         */
        @Override
         ...
         * 
         * @param report
         *            , a ValidationReport object on which found issues are
         *            appened
         */
        @Override
        ...
        /**
         * Return help text for supplied object, as defined in
         * DocResourceManager as long version Note: return an HTML version, with
        ...
        /**
         * Return help text for supplied object, as defined in
         * DocResourceManager as short version Note: return an HTML version,
         * with embedding <html>...</html> tags.
         */
