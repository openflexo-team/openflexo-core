...
public class FMLCastExpression extends CastExpression {

	public FMLCastExpression(Type castType, Expression argument) {
	...
	public Expression transform(ExpressionTransformer transformer) throws TransformException {
		...
		if (!transformedArgument.equals(getArgument())) {
			expression = new FMLCastExpression(getCastType(), transformedArgument);
		}
