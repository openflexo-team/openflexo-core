...
@ImplementationClass(AbstractCreationSchemePathElement.AbstractCreationSchemePathElementImpl.class)
public interface AbstractCreationSchemePathElement<CS extends AbstractCreationScheme>
	...
	public abstract class AbstractCreationSchemePathElementImpl<CS extends AbstractCreationScheme> extends FMLNewInstancePathElementImpl<CS>
			implements AbstractCreationSchemePathElement<CS> {

		static final Logger logger = Logger.getLogger(AbstractCreationSchemePathElement.class.getPackage().getName());
		...
		@Override
		public AbstractCreationSchemePathElement transform(ExpressionTransformer transformer) throws TransformException {
			return this;
		}
