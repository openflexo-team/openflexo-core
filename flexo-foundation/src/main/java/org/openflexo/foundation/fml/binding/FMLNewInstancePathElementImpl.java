 ...
 * 
 */
public abstract class FMLNewInstancePathElementImpl<C extends AbstractConstructor> extends AbstractFMLFunctionPathElementImpl<C>
		implements NewInstancePathElement<C> {

	static final Logger logger = Logger.getLogger(FMLNewInstancePathElementImpl.class.getPackage().getName());

	public FMLNewInstancePathElementImpl() {
		super();
	}

	/*public FMLNewInstancePathElementImpl(Type type, IBindingPathElement parent, String constructorName, List<DataBinding<?>> args) {
		super(parent, constructorName, null, args);
		this.type = type;
	}
	
	public FMLNewInstancePathElementImpl(Type type, IBindingPathElement parent, C constructor, List<DataBinding<?>> args) {
