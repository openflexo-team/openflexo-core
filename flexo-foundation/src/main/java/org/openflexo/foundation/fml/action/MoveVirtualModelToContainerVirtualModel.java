...
public class MoveVirtualModelToContainerVirtualModel extends AbstractMoveVirtualModel<MoveVirtualModelToContainerVirtualModel>
	...
	private CompilationUnitResource containerResource;
	...
	protected void doAction(Object context) {
		...
		List<MovedResourceInfo> allVMResourceInfos = getAllVirtualModelResourceInfos(getFocusedObject().getResource(), oldDirectory,
				newDirectory);

		if (getFocusedObject().getOwningVirtualModel() != null) {
			CompilationUnitResource container = getFocusedObject().getResource().getContainer();
		...
		try {
			...
			// getCompilationUnit().getVirtualModel().addToVirtualModels(getFocusedObject());
	...
	public void setContainerResource(CompilationUnitResource containerResource) {
		if ((containerResource == null && this.containerResource != null)
			...
			CompilationUnitResource oldValue = this.containerResource;
