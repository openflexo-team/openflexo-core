 ...
 *
 */
public class ActionSchemeActionFactory extends AbstractActionSchemeActionFactory<ActionSchemeAction, ActionScheme, FlexoConceptInstance> {

	public ActionSchemeActionFactory(ActionScheme actionScheme, FlexoConceptInstance flexoConceptInstance) {
