...
import org.openflexo.foundation.fml.parser.node.ADirectiveAssign;
import org.openflexo.foundation.fml.parser.node.Node;
import org.openflexo.foundation.fml.parser.node.PDirectiveAssign;
...
public abstract class AssignableDirective extends Directive {
	...
	public AssignableDirective(Node node, PDirectiveAssign assignNode, AbstractCommandSemanticsAnalyzer commandSemanticsAnalyzer) {
		super(node, commandSemanticsAnalyzer);

		if (assignNode instanceof ADirectiveAssign) {
			ADirectiveAssign directiveAssign = (ADirectiveAssign) assignNode;
	...
	protected abstract Object performExecute() throws ExecutionException;
