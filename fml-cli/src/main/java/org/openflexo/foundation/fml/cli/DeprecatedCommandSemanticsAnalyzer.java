 ...
 * 
 */
public class DeprecatedCommandSemanticsAnalyzer extends DepthFirstAdapter {

	private final Map<Node, Expression> expressionNodes;
	private AbstractCommand command;
	private AbstractCommandInterpreter commandInterpreter;

	public DeprecatedCommandSemanticsAnalyzer(AbstractCommandInterpreter commandInterpreter) {
