 ...
 * 
 */
public class CommandSemanticsAnalyzer extends FMLSemanticsAnalyzer {
	...
	/*public CommandSemanticsAnalyzer(FMLCompilationUnit compilationUnit) {
	...
	public CommandSemanticsAnalyzer(AbstractCommandInterpreter commandInterpreter, Start tree) {
		...
		// propertyFactory = new FlexoPropertyFactory(this);
		// behaviourFactory = new FlexoBehaviourFactory(this);
		typingSpace = new CLIFMLTypingSpace(this);
	}
