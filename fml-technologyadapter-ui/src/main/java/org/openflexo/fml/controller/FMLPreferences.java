...
/**
 * Contains preferences for FML Technology Adapter
 * 
 * @author sylvain
 * 
 */
@ModelEntity
@XMLElement(xmlTag = "FMLPreferences")
public interface FMLPreferences extends TechnologyAdapterPreferences<FMLTechnologyAdapter> {
