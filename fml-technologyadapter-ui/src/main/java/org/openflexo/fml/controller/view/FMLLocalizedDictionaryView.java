...
public class FMLLocalizedDictionaryView extends FIBModuleView<FMLCompilationUnit> {

	private final FlexoPerspective perspective;

	public FMLLocalizedDictionaryView(FMLCompilationUnit compilationUnit, FlexoController controller, FlexoPerspective perspective) {
		super(compilationUnit, controller, CommonFIB.FML_LOCALIZED_DICTIONARY_VIEW_FIB,
