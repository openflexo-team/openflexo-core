...
public class CreateModelSlotInitializer extends ActionInitializer<CreateModelSlot, FlexoConceptObject, FMLObject> {
	...
	@Override
	protected FlexoActionInitializer<CreateModelSlot, FlexoConceptObject, FMLObject> getDefaultInitializer() {
		return (e, action) -> {
	...
	@Override
	protected FlexoActionFinalizer<CreateModelSlot, FlexoConceptObject, FMLObject> getDefaultFinalizer() {
		return (e, action) -> {
