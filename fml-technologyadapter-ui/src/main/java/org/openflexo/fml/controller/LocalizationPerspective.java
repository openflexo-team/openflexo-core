 ...
 * @param <TA>
 */
public class LocalizationPerspective extends GenericPerspective {

	static final Logger logger = Logger.getLogger(LocalizationPerspective.class.getPackage().getName());

	public LocalizationPerspective(FlexoController controller) {
		super(controller);
	}
	...
	public String getWindowTitleforObject(FlexoObject object, FlexoController controller) {
		if (object instanceof VirtualModel) {
			return ((VirtualModel) object).getName() + ":locales";
		}
