...
public class MoveVirtualModelToDirectoryInitializer extends ActionInitializer<MoveVirtualModelToDirectory, VirtualModel, FMLObject> {
	public MoveVirtualModelToDirectoryInitializer(ControllerActionInitializer actionInitializer) {
		super(MoveVirtualModelToDirectory.actionType, actionInitializer);
	}
