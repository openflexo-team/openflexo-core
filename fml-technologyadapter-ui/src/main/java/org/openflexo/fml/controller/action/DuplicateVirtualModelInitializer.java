...
public class DuplicateVirtualModelInitializer extends ActionInitializer<DuplicateVirtualModel, VirtualModel, FMLObject> {
	public DuplicateVirtualModelInitializer(ControllerActionInitializer actionInitializer) {
		super(DuplicateVirtualModel.actionType, actionInitializer);
	}

	@Override
	protected FlexoActionRunnable<DuplicateVirtualModel, VirtualModel, FMLObject> getDefaultInitializer() {
		return (e, action) -> {
			Wizard wizard = new DuplicateVirtualModelWizard(action, getController());
