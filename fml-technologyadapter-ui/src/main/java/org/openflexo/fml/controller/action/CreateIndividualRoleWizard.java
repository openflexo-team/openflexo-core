...
public class CreateIndividualRoleWizard extends AbstractCreateFlexoPropertyWizard<CreateIndividualRole> {
	...
	public CreateIndividualRoleWizard(AbstractCreateFlexoRole action, FlexoController controller) {
