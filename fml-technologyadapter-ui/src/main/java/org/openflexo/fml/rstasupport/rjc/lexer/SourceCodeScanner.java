...
class SourceCodeScanner implements org.openflexo.fml.rstasupport.rjc.lexer.TokenTypes {
   ...
   * @exception   java.io.IOException  if any I/O-Error occurs
   */
  public org.openflexo.fml.rstasupport.rjc.lexer.Token yylex() throws java.io.IOException {
    int zzInput;
    int zzAction;
