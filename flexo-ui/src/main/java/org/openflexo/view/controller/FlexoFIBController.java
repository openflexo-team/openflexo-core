...
public class FlexoFIBController extends FIBController implements GraphicalFlexoObserver, PropertyChangeListener {
	...
	public void moveVirtualModelInFolder(VirtualModelResource vmResource, RepositoryFolder receiver) {
		MoveVirtualModelToDirectory action = MoveVirtualModelToDirectory.actionType.makeNewAction(vmResource.getVirtualModel(), null,
				getEditor());
		action.setNewFolder(receiver);
		action.doAction();
	}

	public boolean canMoveVirtualModelInFolder(VirtualModelResource vmResource, RepositoryFolder receiver) {
	...
	public void moveVirtualModelInVirtualModel(VirtualModelResource vmResource, VirtualModelResource container) {
		MoveVirtualModelToContainerVirtualModel action = MoveVirtualModelToContainerVirtualModel.actionType
				.makeNewAction(vmResource.getVirtualModel(), null, getEditor());
		action.setContainerResource(container);
		action.doAction();
	}

	public boolean canMoveVirtualModelInVirtualModel(VirtualModelResource vmResource, VirtualModelResource container) {
