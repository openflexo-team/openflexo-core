...
/**
 * Launching in a terminal: cd
 * /Users/sylvain/GIT-1.9.0/openflexo-core/fml-cli/bin/main
 * 
 * java org.openflexo.foundation.fml.cli.LaunchHeadlessFMLCLI
 * 
 * or
 * 
 * java -cp "Java/*" org.openflexo.foundation.fml.cli.LaunchHeadlessFMLCLI from
 * .app
 * 
 * 
 * @author sylvain
...
public class LaunchFMLTerminal {
	...
	public static FlexoServiceManager createServiceManager(Options options) {
		...
		technologyAdapterService.activateTechnologyAdapter(
				technologyAdapterService.getTechnologyAdapter(FMLTechnologyAdapter.class), true);
		technologyAdapterService.activateTechnologyAdapter(
				technologyAdapterService.getTechnologyAdapter(FMLRTTechnologyAdapter.class), true);
		return manager;
	}
	...
	public static void main(String[] args) throws IOException {
		...
		for (String path : options.rcPaths) {
			...
			if (rcDir.exists()) {
				DirectoryResourceCenter center = DirectoryResourceCenter.instanciateNewDirectoryResourceCenter(rcDir,
						centerService);
