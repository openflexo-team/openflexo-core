...
public class CommonFIB {
	...
	public static File DECLARE_SHAPE_IN_FLEXO_CONCEPT_DIALOG_FIB = new FileResource("Fib/Widget/DeclareShapeInFlexoConceptDialog.fib");
	public static File DECLARE_CONNECTOR_IN_FLEXO_CONCEPT_DIALOG_FIB = new FileResource(
			"Fib/Widget/DeclareConnectorInFlexoConceptDialog.fib");
