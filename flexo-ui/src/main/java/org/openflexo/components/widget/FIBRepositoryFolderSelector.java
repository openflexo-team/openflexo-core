	...
	protected boolean isAcceptableValue(Object o) {
		...
		if (super.isAcceptableValue(o)) {
			if (o instanceof RepositoryFolder) {
				if (getTechnologyAdapter() != null) {
					if (((RepositoryFolder<?>) o).getResourceRepository() instanceof TechnologyAdapterFileResourceRepository) {
						TechnologyAdapterFileResourceRepository repo = (TechnologyAdapterFileResourceRepository) ((RepositoryFolder<?>) o)
