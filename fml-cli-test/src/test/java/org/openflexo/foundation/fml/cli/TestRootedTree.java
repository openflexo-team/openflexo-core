...
public class TestRootedTree extends FMLScriptParserTestCase {

	private static final Logger logger = Logger.getLogger(TestRootedTree.class.getPackage().getName());
	...
	public void loadScript() throws ParseException, ModelDefinitionException, IOException {
		...
		final Resource fmlFile = ResourceLocator.locateResource("TestResourceCenter/AutomatedTests/TestRootedTree.fmlscript");
	...
	public void checkScript() throws ParseException, ModelDefinitionException, IOException {
		...
		checkFMLScript("TestRootedTree.fmlscript", script);
	
		assertEquals(17, script.getCommands().size());
